...
public final class TrunkTest {
    ...
    public void testAddItem() {
        ...
        Assertions.assertNotNull(trunk.getItems().getFirst());
        Assertions.assertEquals(RED_POTION, trunk.getItems().getFirst().getItemId());
        Assertions.assertEquals(5, trunk.getItems().getFirst().getQuantity());
        ...
        Assertions.assertEquals(100, trunk.getItems().getFirst().getQuantity());
