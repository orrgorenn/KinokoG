...
import mapleglory.world.user.data.FuncKeyMapped;
import mapleglory.world.user.data.FuncKeyType;
...
public final class GameConstants {
    ...
    public static final int DEFAULT_ITEM_SLOT_MAX = 200; // CItemInfo::GetBundleItemInfoData
